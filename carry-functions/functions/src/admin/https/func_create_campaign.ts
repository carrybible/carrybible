...
const func_create_campaign = runWith({
  ...
  async (
    ...
    try {
      ...
      return await campaignServices.createCampaign(payload as Request.CampaignRequestModel, userInfo)
    } catch (error: any) {
      logger.error(error)
      return {
        success: false,
...
export default func_create_campaign
