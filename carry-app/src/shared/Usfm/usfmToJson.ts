...
type Options = {
  ...
  convertToInt?: Array<string>
}

export const usfmToJSON: (usfm: string, params: Options) => any = (usfm, params = { ignoreTags: [] }) => {
  ...
  for (let i = 0; i < markers.length; i++) {
    ...
    switch (marker.tag) {
      ...
      default: {
        ...
        if (!params.ignoreTags || !params.ignoreTags.includes(tag0)) {
          if (tag0 === 'v' || tag0 === 'c') {
